const Card = ({artikel}) => {
  return (
    <div className='z-2 bg-slate-50 hover:bg-white drop-shadow-md hover:drop-shadow-xl rounded-2xl mr-2 my-4 hover:cursor-pointer overflow-hidden' onClick={() => window.location.href = '/blogs/'+artikel.id}>
